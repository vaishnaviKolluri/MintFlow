...
struct HomeView: View {
    ...
    private var quickActions: some View {
        HStack(spacing: 16) {
            quickActionTile(icon: "plus.circle.fill",    label: "Add\nExpense", viewModel: HomeViewModel(user: appViewModel.currentUser!))
            quickActionTile(icon: "list.bullet.clipboard", label: "View\nBudgets", viewModel: HomeViewModel(user: appViewModel.currentUser!))
            quickActionTile(icon: "chart.bar.fill",       label: "Analytics", viewModel: HomeViewModel(user: appViewModel.currentUser!))
            quickActionTile(icon: "gearshape.fill",        label: "Settings", viewModel: HomeViewModel(user: appViewModel.currentUser!))
        }
    }
